...
class OrderController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const order = yield database_1.default.query('SELECT * FROM pedido');
            res.json(order[0]);
            console.log(order[0]);
        });
    }
    listById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const order = yield database_1.default.query('SELECT * FROM pedido WHERE Id = ?', [id]);
            if (order.length > 0) {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('UPDATE pedido set ? WHERE Id = ?', [req.body, id]);
